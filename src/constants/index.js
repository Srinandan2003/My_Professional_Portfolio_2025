...
export const PROJECTS = [
  {
    ...
    text:[
      ...
      {text: "Responsive design with smooth animations and transitions."},
      {text: "User-friendly interface for seamless interactions."}
    ],
    liveLink: "https://fanciful-elf-ed4c09.netlify.app",  // Add your live demo URL here
    githubLink: "https://github.com/Dheerajmlk/Frontend-fanatics", // Add your GitHub repository URL here
  },
];
